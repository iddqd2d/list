...
poiTags         = { aerialway = Set { "station" },
					...
					building = Set { "commercial", "industrial", "kiosk", "office", "supermarket", "warehouse" },
...
function WritePOI(class,subclass,rank)
	...
	if (class == "building" or class == "shop") and Find("name:latin") ~= "" or
			(class == "barrier" and subclass == "border_control") or
			(class == "amenity" and (subclass == "weighbridge" or subclass == "fuel"))
	then
