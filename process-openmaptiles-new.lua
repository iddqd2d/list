...
poiTags         = { amenity = Set { "parking_entrance", "shower", "lounge", "townhall", "car_sharing", "car_rental", "exhibition_centre","weighbridge", "vehicle_inspection", "cafe", "fast_food", "ferry_terminal", "food_court", "fuel", "marketplace", "parking", "police", "post_office", "restaurant", "toilets" },
					barrier = Set { "border_control", "toll_booth" },
					building = Set { "commercial", "industrial", "office", "supermarket", "warehouse", "government", "retail", "hotel"},
					shop = Set { "trailer", "food", "truck", "accessories", "car", "car_repair", "coffee", "convenience", "hardware", "mall", "supermarket" },
					tourism = Set { "apartment", "bed_and_breakfast", "camp_site", "caravan_site", "hostel", "hotel", "motel" },
					craft = { "car_painter", "sawmill", "agricultural_engines" },
					highway = Set { "rest_area", "toll_gantry", "services" }
}
...
poiClassRanks   = { border_control=1, weighbridge=1, vehicle_inspection=2, ferry_terminal=2, fuel=2, parking=2,
					police=2, commercial=2, industrial=2, office=2, supermarket=2, warehouse=2,
					hotel=2, truck=2, mall=2, supermarket=2, golf=17, shop=18, grocery=19,
...
poiFirstClassRank = Set { "weighbridge", "border_control", "fuel", "parking", "warehouse", "rest_area"}
...
function WritePOI(class,subclass,rank)
	...
	if postcode ~= "" then
		Attribute("addr:postcode", postcode)
	end
